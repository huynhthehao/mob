 ...
 *
 * Last modified 6/22/18 1:17 PM  by hien.nguyenm
 */
...
public class CryptoHelperImpl implements CryptoHelper {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public <T> T decryptObject(String enscriptedObject, Class<T> type) {
        try {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public String signWithRSAPem(String privateKeyString, String message) {
        try {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public String signWithRSAPem(String message) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public boolean verifyRSASignedString(String publicKeyString, String message, String signature) {
        try {
