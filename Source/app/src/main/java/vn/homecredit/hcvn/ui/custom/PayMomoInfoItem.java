...
public class PayMomoInfoItem extends RelativeLayout {
    ...
    public PayMomoInfoItem(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PayMomoInfoItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PayMomoInfoItem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
